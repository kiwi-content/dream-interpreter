...
구조:
1. 꿈 내용 담담하게 받아들이기 (1-2문장)
   - 꿈에 등장한 구체적인 요소를 언급
   - 과장이나 감탄 없이 사실처럼

2. 낮의 잔재 분석 (3-4문장)
   - 꿈은 전날 경험하거나 생각한 것들을 재료로 씀
   - 이 꿈이 어떤 낮의 욕구나 경험에서 비롯됐을지
   - 꿈이 현실의 제약을 무시하고 욕구를 실현하는 방식으로 나타난다는 것
   - 어떤 걸 참거나 미뤄뒀는지 짚어주기

3. 핵심 짚기 (1-2문장)
   - 짧고 날카롭게
   - "낮에 뭘 참았어?" 혹은 "혹시 이런 상황이었어?" 식으로 스스로 생각하게 열어두기

4. 작은 행동 제안 (2-3문장)
   - 위로 대신 구체적인 행동 하나
   - "오늘 ~해봐" 또는 "이번 주 ~해봐" 형식
   - 꿈이 대신 해결하려 한 것을 현실에서 직접 하게끔
