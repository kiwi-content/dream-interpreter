...
export default function EnHome() {
  ...
  const dreamKeywords = [
    ...
    { name: 'Lost Item Dream Meaning', slug: 'lost-dream' },
    { name: 'Getting Lost Dream Meaning', slug: 'maze-dream' },
    { name: 'Elevator Dream Meaning', slug: 'elevator-dream' },
    { name: 'Stairs Dream Meaning', slug: 'stairs-dream' },
    { name: 'Train Dream Meaning', slug: 'train-dream' },
    { name: 'Bus Dream Meaning', slug: 'bus-dream' },
    { name: 'Airplane Dream Meaning', slug: 'airplane-dream' },
    { name: 'Boat Dream Meaning', slug: 'boat-dream' },
    { name: 'School Dream Meaning', slug: 'school-dream' },
    { name: 'Office Dream Meaning', slug: 'office-dream' },
    { name: 'Moving House Dream Meaning', slug: 'moving-dream' },
    { name: 'Cleaning Dream Meaning', slug: 'cleaning-dream' },
    { name: 'Rain Dream Meaning', slug: 'rain-dream' },
    { name: 'Snow Dream Meaning', slug: 'snow-dream' },
    { name: 'Wind Dream Meaning', slug: 'wind-dream' },
    { name: 'Mountain Dream Meaning', slug: 'mountain-dream' },
    { name: 'Flower Dream Meaning', slug: 'flower-dream' },
    { name: 'Tree Dream Meaning', slug: 'tree-dream' },
    { name: 'Fruit Dream Meaning', slug: 'fruit-dream' },
    { name: 'Eating Dream Meaning', slug: 'eating-dream' },
    { name: 'Cooking Dream Meaning', slug: 'cooking-dream' },
    { name: 'Bath Dream Meaning', slug: 'bath-dream' },
    { name: 'Toilet Dream Meaning', slug: 'toilet-dream' },
    { name: 'Clothes Dream Meaning', slug: 'clothes-dream' },
    { name: 'Shoes Dream Meaning', slug: 'shoes-dream' },
    { name: 'Bag Dream Meaning', slug: 'bag-dream' },
    { name: 'Phone Dream Meaning', slug: 'phone-dream' },
    { name: 'Photo Dream Meaning', slug: 'photo-dream' },
    { name: 'Letter Dream Meaning', slug: 'letter-dream' },
    { name: 'Travel Dream Meaning', slug: 'travel-dream' },
    { name: 'Hospital Dream Meaning', slug: 'hospital-dream' },
    { name: 'Surgery Dream Meaning', slug: 'surgery-dream' },
  ]
